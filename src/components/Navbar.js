              ...
              <div className="flex px-2 lg:px-0">
                <div className="flex-shrink-0 flex items-center">
                  <img
                    ...
                    src="https://miro.medium.com/max/1400/1*HdN03ndACEsOdxCmZzuxeA.png"
                    alt="Workflow"
                  />
                  <img
                ...
                <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
                  ...
                  <NavLink to="/Projects" activeClassName="border-pink-500 text-black hover:border-pink-500 hover:text-black" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    Projects
                  </NavLink>
                  <NavLink to="/TeamCalendar" activeClassName="border-pink-500 text-black hover:border-pink-500 hover:text-black" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    Calendar
                  </NavLink>
                  ...
                  <NavLink to="/MyNotifications" activeClassName="border-pink-500 text-black hover:border-pink-500 hover:text-black" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    MyNotifications
                  </NavLink>
                ...
                <Menu as="div" className="ml-4 relative flex-shrink-0">
                  <div>
                    <Menu.Button className="bg-white rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      ...
                      <img
                        ...
                        src="https://avatars.githubusercontent.com/u/60107512?s=40&v=4&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
                  ...
                  >
                    <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <NavLink to="/userQuestions" className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>
                            User Questions
                          </NavLink>
                        )}
                      </Menu.Item>
                      <Menu.Item>
                        {({ active }) => (
                          <NavLink to="/Portal" className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>
                            Customer Portal
                          </NavLink>
                        )}
                      </Menu.Item>
