...
exports.messages = {
    ...
    force_function_start_warning_plugin_not_installed: 'To run this command, install the Salesforce Functions plugin. For more info, see [Getting Started with Salesforce Functions](https://dev.beta.developer.salesforce.com/docs/platform/functions/guide/vs-intro.html#prerequisites).',
    ...
    conflict_detect_initialization_error: 'Unexpected error initiliazing metadata cache',
