    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (commandlet.onDidFinishExecution) {
            commandlet.onDidFinishExecution((startTime) => __awaiter(this, void 0, void 0, function* () {
                ...
                telemetry_1.telemetryService.sendCommandEvent('force_function_debug_invoke', startTime, { language: functionService_1.FunctionService.instance.getFunctionLanguage() });
            }));
        }
    });
}
