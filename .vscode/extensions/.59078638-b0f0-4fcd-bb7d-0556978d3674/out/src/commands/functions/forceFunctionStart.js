...
class ForceFunctionStartExecutor extends util_2.SfdxCommandletExecutor {
    ...
    execute(response) {
        ...
        cancellationToken.onCancellationRequested(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this.logMetric('force_function_start_cancelled', startTime, { language: functionService_1.FunctionService.instance.getFunctionLanguage() });
        }));
        ...
        execution.stdoutSubject.subscribe(data => {
            const matches = String(data).match(constants_1.FUNCTION_RUNTIME_DETECTION_PATTERN);
            if (matches && matches.length > 1) {
                ...
                notifications_1.notificationService
                    ...
                    .catch(() => { });
                this.logMetric(execution.command.logName, startTime, { language: functionService_1.FunctionService.instance.getFunctionLanguage() });
            }
        });
...
function forceFunctionStart(sourceUri) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        telemetry_1.telemetryService.sendCommandEvent(LOG_NAME, startTime, { language: functionService_1.FunctionService.instance.getFunctionLanguage() });
    });
}
