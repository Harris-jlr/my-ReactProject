...
const index_1 = require("@salesforce/salesforcedx-utils-vscode/out/src/index");
...
class QuickLaunch {
    ...
    runSingleTest(connection, testClass, testMethod) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield testService.runTestSynchronous(payload);
    ...
    retrieveLogFile(connection, logId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const outputDir = index_1.getLogDirPath();
