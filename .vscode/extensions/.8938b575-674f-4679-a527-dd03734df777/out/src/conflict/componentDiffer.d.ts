 ...
 */
export declare function diffComponents(projectComponent: SourceComponent, cacheComponent: SourceComponent, projectRoot: string, cacheRoot: string): ComponentDiff[];
