...
exports.messages = {
    ...
    force_function_start_warning_no_toml: 'No function.toml found. Create a function.toml, or create a new function using SFDX: Create Function.',
    force_function_start_warning_not_in_function_folder: 'Open a function file to run SFDX: Start Function',
    force_function_start_warning_plugin_not_installed: 'To run this command, install the Salesforce Functions plugin. For more info, see [Getting Started with Salesforce Functions](https://github.com/forcedotcom/evergreen-docs/blob/master/Getting%20Started%20Guide/Evergreen%20Getting%20Started%20Guide.md#installing-the-salesforce-functions-sfdx-plugin).',
    ...
    force_function_start_unexpected_error: 'SFDX: Start Function exited unexpectedly with code %s',
    ...
    conflict_detect_empty_results: 'Conflict Detection failed to retrieve org file state',
    ...
    force_source_diff_remote_not_found: 'Selected file or directory was not found in the org',
